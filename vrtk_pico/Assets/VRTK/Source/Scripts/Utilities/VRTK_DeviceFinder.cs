...
namespace VRTK
{
    ...
    public static class VRTK_DeviceFinder
    {
        ...
        {
                //Debug.Log("get controller hand: "+ controller.name);

            if (VRTK_SDK_Bridge.IsControllerLeftHand(controller))
            {
                //Debug.Log("get controller left hand: " + VRTK_SDK_Bridge.IsControllerLeftHand(controller));

                return SDK_BaseController.ControllerHand.Left;
            }
            else if (VRTK_SDK_Bridge.IsControllerRightHand(controller))
            {
                //Debug.Log("get controller right hand: " + VRTK_SDK_Bridge.IsControllerRightHand(controller));
